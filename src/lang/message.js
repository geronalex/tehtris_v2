...
const messages = {
  'en': {
    ...
    newHeroTeam:"Hero's team (DC Comics or Marvel Comics)",


  },
  'fr': {
    titleMsg:'L\'almanach des super héros',
    welcomeMsg: 'Bienvenue sur l\'almanach des super héros, cette application a pour but de vous donner un listing des principeaux super héros des univers Marvel et DC.',
    ...
    newHeroTeam:"Team du héros (DC Comics ou Marvel Comics)",
  }
};
